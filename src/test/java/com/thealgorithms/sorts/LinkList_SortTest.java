...
public class LinkList_SortTest {
	@Test
	void testNullList() {
		assertThrows(java.lang.IllegalArgumentException.class, () -> LinkList_Sort.isSorted(null));
	}
	...
	void testUnsortedList() {
		...
		start.next = new Node();
		start.next.val = 1;
		assertFalse(LinkList_Sort.isSorted(start));
	}

	@Test
	void testInvalidSortingChoice() {
		int a[] = { 1 };
		assertTrue(LinkList_Sort.sortWith(a, 4) == null);
	}
